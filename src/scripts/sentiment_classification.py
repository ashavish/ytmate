...
from src.scripts.utils import download_source_file_from_s3, upload_file, download_folder
import os
import json
from src.scripts.settings import BUCKET_NAME, LOCAL_MODEL_FOLDER
...
def classify_sentiment(text_json, source, video_id, force_train):
    try:
        ...
        LOGGER.error(f"Error doing sentiment classification {e}")
        raise
    return emotion_percent
