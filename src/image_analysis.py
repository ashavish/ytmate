...
import os
from src.settings import LOCAL_DOWNLOAD_FOLDER
from src.utils import upload_file, download_file, download_folder
from src.settings import BUCKET_NAME, LOCAL_MODEL_FOLDER, DISABLE_IMAGE_CAPTIONING
from src import LOGGER

if not DISABLE_IMAGE_CAPTIONING:
    try:
